      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            else if (header.indexOf("GET /7/ligado") >= 0) {
            ...
            // Acendendo led azul
            else if (header.indexOf("GET /3/ligado ") >= 0) {
            ...
            else if (header.indexOf("GET /15/ligado") >= 0) {
            ...
            else if (header.indexOf("GET /6/ligado") >= 0) {
            ...
            // Acendendo led verde
            else if (header.indexOf("GET /5/ligado") >= 0) {
            ...
            if (output5State=="desligado") {
              ...
              client.println("<h1>UHUUUUUL!!!PARABENS VOCE E O GRANDE VENCEDOR DESTE JOGO!!</h1>");
            }
